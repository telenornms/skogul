...
func (ExtensionID) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e4fe0700585f3661, []int{0}
}
...
func (*RegisteredExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4fe0700585f3661, []int{1}
}
...
func (*MasterArbitration) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4fe0700585f3661, []int{2}
}
...
func (*Uint128) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4fe0700585f3661, []int{3}
}
...
func (*Role) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4fe0700585f3661, []int{4}
}
...
func init() { proto.RegisterFile("gnmi_ext.proto", fileDescriptor_e4fe0700585f3661) }

var fileDescriptor_e4fe0700585f3661 = []byte{
