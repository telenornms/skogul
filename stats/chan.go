...
The stats are very generic and are sent as regular `skogul.Metric`s. By
configuring the stats receiver all stats will be picked up and sent through
skogul as any other metrics.
*/
package stats
