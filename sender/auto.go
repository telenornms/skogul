...
func init() {
	Auto.Add(skogul.Module{
		...
		Alloc:   func() any { return &Backoff{} },
		Help:    "DEPRECATED, use the retry settings on the sender itself. Forwards data to the next sender, retrying after a delay upon failure. For each retry, the delay is doubled. Gives up after the set number of retries. Note that wrapping a sender which does its own retries multiplies the number of attempts.",
	})
	Auto.Add(skogul.Module{
		Name:    "batch",
		Aliases: []string{"batcher"},
		Alloc:   func() any { return &Batch{} },
	...
	Auto.Add(skogul.Module{
		...
		Alloc:   func() any { return &Detacher{} },
	...
	Auto.Add(skogul.Module{
		Name:  "fallback",
		Alloc: func() any { return &Fallback{} },
	...
	Auto.Add(skogul.Module{
		Name:  "file",
		Alloc: func() any { return &File{} },
		Help:  "Writes metrics to a file.",
	})
	Auto.Add(skogul.Module{
		Name:  "forwardfail",
		Alloc: func() any { return &ForwardAndFail{} },
	...
	Auto.Add(skogul.Module{
		...
		Alloc:   func() any { return &InfluxDB{} },
