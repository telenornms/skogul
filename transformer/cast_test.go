...
func TestCast(t *testing.T) {
	...
	checkM(t, c.Metrics[0], "minttostring", "3")
	checkM(t, c.Metrics[0], "mfloattostring", "3.14")
	checkM(t, c.Metrics[0], "mstringtostring", "pi")
	checkM(t, c.Metrics[0], "minttofloat", 3.0)
	checkM(t, c.Metrics[0], "mfloattofloat", 3.14)
	checkM(t, c.Metrics[0], "mstringtofloat", 3.14)
	checkM(t, c.Metrics[0], "minttoint", 3)
	checkM(t, c.Metrics[0], "mfloattoint", 3)
	checkM(t, c.Metrics[0], "mstringtoint", 3)
	checkM(t, c.Metrics[0], "mflatten", "314159265358979")
	...
	checkD(t, c.Metrics[0], "dinttostring", "3")
	checkD(t, c.Metrics[0], "dfloattostring", "3.14")
	checkD(t, c.Metrics[0], "dstringtostring", "pi")
	checkD(t, c.Metrics[0], "dinttofloat", 3.0)
	checkD(t, c.Metrics[0], "dfloattofloat", 3.14)
	checkD(t, c.Metrics[0], "dstringtofloat", 3.14)
	checkD(t, c.Metrics[0], "dinttoint", 3)
	checkD(t, c.Metrics[0], "dfloattoint", 3)
	checkD(t, c.Metrics[0], "dstringtoint", 3)
